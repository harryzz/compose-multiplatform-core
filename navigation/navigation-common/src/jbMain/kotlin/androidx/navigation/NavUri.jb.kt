...
public actual object NavUriUtils {
    internal actual fun encode(s: String, allow: String?): String = InternalUri.encode(s, allow)
    internal actual fun decode(s: String): String = InternalUri.decode(s)
    public actual fun parse(uriString: String): NavUri = ActualUri(uriString)
}
